package com.infy.ci.batamqpservice;
...
@Component
@Configuration
@RequestMapping("/battestdata")
public class BatAmqpRestController {
	...
	private final Logger logger = LoggerFactory.getLogger(BatAmqpRestController.class);
	

	@RequestMapping(value = "/{projectid}/bat/aggregate", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/bat/modulewise", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/bat/week", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/bat/month", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/bat/custom", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	...
	@RequestMapping(value = "/{projectid}/bat/{buildnumber}", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
